...
function  WWHControlEntry_GetHTML()
{
  ...
  //
  //vmware adding padding so wil be aligned to the center
  VarStyleAttribute = " style=\"font-size: 1px; padding-top:3px; line-height: 1px;\"";
  ...
  if (this.mbEnabled)
  {
   ...
   // vmware was w=23, h=21
    VarHTML += "<img name=\"" + this.mControlName + "\" alt=\"" + VarLabel + "\" border=\"0\" src=\"" + this.fGetIconURL() + "\" width=\"16\" height=\"16\">"; 
    VarHTML += "</a>";
    VarHTML +=" </div>";
    VarHTML += "</td>\n";
  }
