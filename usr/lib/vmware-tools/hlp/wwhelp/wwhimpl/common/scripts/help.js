...
function  WWHHelp_GetFrameReference(ParamFrameName)
{
  ...
  switch (ParamFrameName)
  {
    ...
    case "WWHNavigationFrame":
      ...
      //
      VarFrameReference = "WWHFrame.frames[1]"; //0
      break;
    ...
    case "WWHContentFrame":
      ...
      {
        VarFrameReference = "WWHFrame"; // no frames //.frames[1]
      }
      else
      {
        VarFrameReference = "WWHFrame.frames[2]"; //1
      }
      //alert(ParamFrameName + "=" + VarFrameReference);
      break;
